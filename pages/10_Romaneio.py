...
# Carrega opções do banco (Materiais cadastrados)
...
def gerar_romaneio_docx(dados, df_materiais):
    ...
    # --- TABELA DE MATERIAIS (4 COLUNAS) ---
    # Estrutura: Descrição | Detalhe | Unid | Qtd
...
if col_btn2.button("📄 Gerar DOCX para Impressão", type="primary"):
    # Filtra linhas onde MATERIAL não está vazio
    ...
    if not df_final.empty:
        ...
        st.warning("Preencha pelo menos um material (Coluna Descrição) para gerar o documento.")
