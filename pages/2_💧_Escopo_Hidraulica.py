...
with tab3:
    ...
    itens_m = [
        ...
        "Válvulas de controle e balanceamento", "Plataformas elevatórias e/ou andaimes", 
        "Ferramentas manuais e bancadas", "Escadas tipo \"A\"", "Alimentação, viagem, hospedagem", "Epis", "Uniformes"
    ]
    nome_m = forn.upper()
