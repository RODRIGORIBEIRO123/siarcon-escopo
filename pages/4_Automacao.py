...
ITENS_MATRIZ = [
    ...
    "Infraestrutura Elétrica", "Treinamento Operacional", "Manual de Operação"
]

st.set_page_config(page_title="Escopo Automação", page_icon="🤖", layout="wide")# --- INÍCIO DO CORPO DO CÓDIGO (COPIAR PARA TODOS OS ARQUIVOS) ---
