...
def gerar_docx(dados):
    ...
    for d in ["Ficha de registro", "ASO", "Ficha EPI", "NR-35"] + dados.get('nrs_selecionadas', []): document.add_paragraph(d, style='List Bullet')
...
with tab5:
    ...
    status = st.selectbox("Status", ["Em Elaboração (Engenharia)", "Aguardando Obras", "Recebido (Suprimentos)", "Contratação Finalizada"])
